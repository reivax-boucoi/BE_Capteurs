...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x4800044Cu)
...
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48000464u)

/* PHUB_CFGMEM1 Address: CYREG_PHUB_CFGMEM1_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x4800046Cu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR0_SW0, 0x22u);
